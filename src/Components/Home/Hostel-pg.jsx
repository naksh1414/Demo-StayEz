    ...
    <main className="my-[100px] h-full">
      <div className="w-full flex flex-col-reverse md:flex-row-reverse justify-center items-center">
        <div className="w-full md:w-[50%] justify-center items-center">
          <h1 className="text-white text-[1.3rem] md:text-[1.6rem] lg:text-[4rem] font-bold md:pl-14 md:pr-28 px-5">
          ...
          <p className="text-white text-[1.1rem] md:text-[1.4rem] md:pl-14 md:pr-28 px-5 mt-2">
        ...
        <div className="w-full md:w-[50%] p-5 md:pl-28">
