...
const Footer = () => {
  ...
  return (
    <main className="bg-[#152038] flex-col flex justify-center items-center w-full h-[400px] px-3">
      {/* <img className="object-cover w-full" src={FImg} alt="" /> */}
      <div className="text-white text-[1.4rem] font-semibold flex justify-around w-[80%] mt-5">
        <h1>Help</h1>
        <h1>About</h1>
        <h1>Company</h1>
        <h1>Services</h1>
      ...
      <div className="border-t-2 w-full mt-10 flex items-center justify-between">
