...
const Flats = () => {
  ...
  return (
    <main>
      <div className="flex justify-center text-white text-[1.4rem] md:text-[2.8rem] font-semibold my-8">
        Popular in&nbsp;<span className="text-[#03A9F4] underline">GHAZIABAD</span>
      </div>
